...
libtechc:
	...
	cd "techlib/C/src"; ${CC} ${CFLAGS} ${SRC} -o ../lib/libtechc.so.${VERSION}

libtechcpp: 
	@echo "Creating 'libtechcpp.so.${VERSIONXX}'..."
	cd "techlib/CPP/src"; ${CXX} ${CXXFLAGS} ${SRCXX} -o ../lib/libtechcpp.so.${VERSIONXX}


install: ./techlib/C/lib/libtechc.so.${VERSION} ./techlib/CPP/lib/libtechcpp.so.${VERSIONXX}
...
ifeq ($(IS_INSTALLED),1)
	...
	@cp  ./techlib/C/include/* ${INCLUDE_DIR}/techlib/C
	@cp  ./techlib/CPP/include/* ${INCLUDE_DIR}/techlib/CPP
