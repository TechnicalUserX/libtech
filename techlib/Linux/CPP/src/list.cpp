...
techlib::list::list_t::list_t(techlib::list::list_type type){
    this->size = 0;
    this->type = type;
    this->objects = NULL;
}

techlib::list::list_t::~list_t(){
    this->clear();
}

techlib::list::list_object_type techlib::list::list_runtime_get_type(const std::size_t hash){
...
int techlib::list::list_t::print_all(){
...
int techlib::list::list_t::remove(int index){
