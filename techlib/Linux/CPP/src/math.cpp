...
int techlib::math::isprime(long long n){
...
long long techlib::math::random_number_range(long long min, long long max){
    long long dif = max-min;
    return (rand() % (dif+1)) + min;
}

long long techlib::math::random_prime_range(long long min, long long max){
    long long dif = max-min;
...
// Euclidian Algorithm //
long long techlib::math::gcd(long long a, long long h)
{
    while(1)
    {
        long long temp = a % h;
...
unsigned long long techlib::math::lcm(int count, ...)
{
    int n = count;
...
long long techlib::math::fast_factorial_modulus(long long fact,long long modulo){
...
long long techlib::math::fast_factorial_modulus_2(long long fact, long long modulo){
...
long long techlib::math::fast_exponential_modulus(long long base, long long exp, long long modulo){
...
long long techlib::math::fast_exponential_modulus_2(long long base, long long exp, long long modulo){
...
long long techlib::math::fast_multiplication_modulus(long long x, long long y, long long modulo){
