    ...
    namespace list{
        ...
        public:
            ...
            // Constructor-Destructor
                list_t(list_type type = LIST_TYPE_DEFAULT);
                ~list_t();
        ...
        list_t::list_t(techlib::list::list_type type){
            this->size = 0;
            this->type = type;
            this->objects = NULL;
        }
        ...
        template <typename list_append_type>    int             list_t::append(list_append_type element){
        ...
        template <typename list_prepend_type>   int             list_t::prepend(list_prepend_type element){
        ...
        template <typename list_insert_type>    int             list_t::insert(list_insert_type element,int index){
        ...
        template <typename list_get_type>       list_get_type   list_t::get(int index){
        ...
        template <typename list_set_type>       int             list_t::set(list_set_type element, int index){
        ...
        template <typename list_sort_type>      int             list_t::sort(list_sort_method method ){
        ...
        list_object* techlib::list::list_t::operator[](int index){
        ...
        int list_t::modify_data(int index, void* element){
